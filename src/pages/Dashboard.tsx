    ...
    try {
      ...
      if (accountsResponse.success && accountsResponse.accounts) {
        ...
        setMetrics({
          ...
          engagementRate: 8.4, // Default for now
          ...
          <div className="lg:col-span-1">
            <GlassCard className="p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Create Content', icon: Plus, action: () => navigate('/') },
                  { label: 'Schedule Post', icon: Calendar, action: () => navigate('/scheduled-posts') },
                  { label: 'View Analytics', icon: BarChart3, action: () => navigate('/analytics') },
                  { label: 'Manage Accounts', icon: Users, action: () => navigate('/accounts') }
                ].map((action, index) => {
